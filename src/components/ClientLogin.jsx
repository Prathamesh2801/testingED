                        ...
                        <div className="w-full lg:w-1/2 p-8 lg:p-12">
                            <div className="max-w-md mx-auto">
                                <div className="flex flex-col md:flex-row items-center justify-center md:gap-12">
                                    <img src={`${API_BASE_URL}/uploads/event_logos/${eventData.Event_Logo}`} alt="" className="w-20 h-20 mb-8 rounded-full" />
                                    <h1 className="text-4xl text-gray-900 mb-8 font-jersey-25 tracking-wide text-center">{eventData.Event_Name}</h1>
                                </div>

...
import { ArrowDownTrayIcon, ArrowUpTrayIcon, DocumentArrowUpIcon, XMarkIcon } from '@heroicons/react/24/outline'
...
export default function ClientSection() {
  ...
  const [fileConfig, setFileConfig] = useState(null) // holds field metadata
  ...
  const UploadModal = () => {
    return (
      <Dialog open={isUploadModalOpen} onClose={handleCloseModal} className="relative z-10">
        <DialogBackdrop
  ...
  return (
    <div>
      ...
      {view === 'display' ? <ClientDataTable onRefresh={refreshKey} /> : <CreateNewClientEvent userId={userId} />}

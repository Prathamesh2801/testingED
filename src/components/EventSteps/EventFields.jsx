...
function EventFields({ onSubmit, onPrevious, initialData = [] }) {
  ...
  const hasUserIDField = fields.some((field) => field.isUserID);
  ...
  const handleFieldChange = (index, field) => {
    ...
    if (field.isUserID && !newFields[index].isUserID) {
    ...
    if (newFields[index].isUserID && (!field.required || !field.unique)) {
      field.isUserID = false;
    }
  ...
  const handleDeleteEnumValue = (fieldIndex, valueIndex) => {
    ...
    newFields[fieldIndex] = {
      ...newFields[fieldIndex],
      enumValues: newFields[fieldIndex].enumValues.filter(
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <form onSubmit={handleSubmit}>
            ...
            <div key={index} className="mb-4 p-4 border rounded-lg">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-1 md:gap-8">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleFieldChange(index, {
                        ...
                        type: e.target.value,
                        enumValues:
                          e.target.value === "enum" ? [] : field.enumValues,
                ...
                <div className="flex flex-col space-y-2">
                  <div className="flex items-center space-x-4">
                    <label className="flex items-center">
                      <input
                        ...
                        className="mr-2"
                        disabled={field.isUserID}
                      />
                      <span className={field.isUserID ? "text-gray-400" : ""}>
                        Required
                      </span>
                    </label>
                    <label className="flex items-center">
                  ...
                  {(!hasUserIDField || field.isUserID) && (
                    <label className="flex items-center">
                      <input
                        type="checkbox"
                        checked={field.isUserID}
                        onChange={(e) =>
                          handleFieldChange(index, {
                            ...field,
                            isUserID: e.target.checked,
                          })
                        }
                        className="mr-2"
                      />
                  ...
                  {field.isUserID && (
                    <span className="text-xs text-blue-500 font-medium">
                      ✓ This field will be used for unique user registration
                    </span>
                  )}
                </div>
              </div>
        ...
        </div> {/* ✅ Fixed missing closing tag here */}

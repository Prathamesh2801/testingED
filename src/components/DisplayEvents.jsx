...
export default function DisplayEvents({
  ...
  async function handleRedirectEvent(eventId) {
    try {
      ...
      toast.error(error.message || "Something went wrong while fetching event");
    }
  }
        ...
        cell: (info) => (
          <div className="flex space-x-6">
            ...
            <button
              ...
              className="text-shadow-emerald-600  hover:text-shadow-emerald-900 cursor-pointer"
